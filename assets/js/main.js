...
$.each(stationary, function(k, v) {
    stationaryThumbContainer.append('<div class="content" data-toggle="modal" data-target="#'+v.name+'"><img src="http://ingridwu.dmmdmcfatter.com/wp-content/uploads/2015/01/placeholder.png" data-src="'+v.thumbSrc+'" alt="content"></div>');
...
$.each(logos, function(k, v) {
    logosThumbContainer.append('<div class="content" data-toggle="modal" data-target="#'+v.name+'"><img src="http://ingridwu.dmmdmcfatter.com/wp-content/uploads/2015/01/placeholder.png" data-src="'+v.thumbSrc+'" alt="content"></div>');
...
$.each(prints, function(k, v) {
    printsThumbContainer.append('<div class="content" data-toggle="modal" data-target="#'+v.name+'"><img src="http://ingridwu.dmmdmcfatter.com/wp-content/uploads/2015/01/placeholder.png" data-src="'+v.thumbSrc+'" alt="content"></div>');
    if (v.portrait) {
...
$.each(featuredPosters, function(k, v) {
    featuredPostersContainer.append('<div class="content" data-toggle="modal" data-target="#'+v.name+'"><img src="http://ingridwu.dmmdmcfatter.com/wp-content/uploads/2015/01/placeholder.png" data-src="'+v.posterSrc+'" alt="content"></div>');
...
$.each(comicPosters, function(k, v) {
    comicThumbContainer.append('<div class="content" data-toggle="modal" data-target="#'+v.name+'"><img src="http://ingridwu.dmmdmcfatter.com/wp-content/uploads/2015/01/placeholder.png" data-src="'+v.posterThumbSrc+'" alt="content"></div>');
    posterModals.append('<div class="modal" id="'+v.name+'" aria-hidden="true" tabindex="-1" role="dialog"><div class="modal-dialog portrait" role="document"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body"><img class="lazy" src="'+v.posterSrc+'" alt="content"></div><div class="modal-footer"><a href="'+v.buyLink+'" target="_blank"><div class="buy-button"><span>Buy Now</span></div></a></div></div></div></div></div>');  
});
